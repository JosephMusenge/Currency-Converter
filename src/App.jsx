...
function App() {
  ...
  // Using a custom hook to get currency information based on the source currency
  const currencyInfo = useCurrencyInfo(from)
  // Extracting currecny options from the currencyInfo object
  const options = Object.keys(currencyInfo)

  // Function to swap the source and target currencies in the app
  const swap = () => {
    setFrom(to)
    setTo(from) 
